<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Laboratrian.aspx.cs" Inherits="Clinic_Management_System.Views.Admin.Laboratrian" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Mybody" runat="server">
        ...
        <div class="row">
            <div class="col-md-4">
                <h2>Laboratorian Details</h2>
                <form>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label" runat="server">Name</label>
                        <input type="text" class="form-control" id="LabNameTb" runat="server"/>
                    </div>
                    <div class="mb-3">
                        <label for="EmailTb" class="form-label" runat="server">Email</label>
                        <input type="text" class="form-control" id="LabEmailTb" runat="server"/>
                    </div>
                    <div class="mb-3">
                        <label for="PasswordTb" class="form-label" runat="server">Password</label>
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        <label for="GenderTb" class="form-label" runat="server">Gender</label>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col">
                        <img src="../../Assets/Images/laboratorian.jpg" height="350px" width="100%" class="rounded-3" />
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <h1>Laboratorian Details</h1>
                        <asp:GridView ID="LaboGV" runat="server" class="table table-hover" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="LaboGV_SelectedIndexChanged">
